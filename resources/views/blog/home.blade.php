@extends('layouts.blog.template'){{--  aqui vai puxar a pagina template para o principal.// --}} 
@section('title, "Blog Café para Dev | Página Inicial"')
@section('content') {{-- aqui puxou la da pagina layouts\blog\template em content --}}  
    <h1>Blog Home</h1>
